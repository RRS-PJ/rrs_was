 ...
 * */
@Component // 스프링에서 해당 클래스를 관리하도록 지정, 애플리케이션에서 자동으로 사용될 수 있도록 설정(의존성 주입)
    ...
    * */
    ...
    private void setAuthenticationContext(HttpServletRequest request, String userId) {
        ...
        AbstractAuthenticationToken authenticationToken
                = new UsernamePasswordAuthenticationToken(userId, null, AuthorityUtils.NO_AUTHORITIES); //AUTHORITIES 권한
